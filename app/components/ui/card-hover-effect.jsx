  ...
  return (
    ...
    >
      {items.map((item, idx) => (
        <div
          key={item.title}
          className="relative group block p-4 h-full w-full rounded-2xl overflow-hidden border border-transparent bg-neutral-900"
        >
          <Link
            href={item.link}
            className="relative block p-4 h-full w-full rounded-2xl overflow-hidden"
          >
            <AnimatePresence>
              {hoveredIndex === idx && (
                <motion.span
            ...
            <div
              className="flex flex-col md:flex-row gap-6 items-start relative z-20"
            ...
            >
              ...
              <div className="flex flex-col justify-between w-full py-5 md:w-1/2">
                ...
                <div className="mt-4 px-4 py-2 bg-yellow-400 text-black rounded-full text-center hover:bg-yellow-600">
                  বিস্তারিত
                </div>
              </div>
            </div>
